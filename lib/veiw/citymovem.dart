...
import 'package:meribilty/veiw/somecitymov.dart';
...
class Citymovem extends StatefulWidget {
  const Citymovem({Key? key}) : super(key: key);

  @override
  _CitymovemState createState() => _CitymovemState();
}

class _CitymovemState extends State<Citymovem> {
            ...
            child: GFButton(
             borderShape: ShapeBorder.lerp(RoundedRectangleBorder(side: BorderSide.none, borderRadius:  BorderRadius.circular(10.0)), RoundedRectangleBorder(side: BorderSide.none, borderRadius: BorderRadius.circular(10.0)), 0.5),
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Somecitymov()),
                );
              },
