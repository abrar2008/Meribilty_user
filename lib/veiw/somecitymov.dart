...
class Somecitymov extends StatefulWidget {
  const Somecitymov({Key? key}) : super(key: key);

  @override
  _SomecitymovState createState() => _SomecitymovState();
}

class _SomecitymovState extends State<Somecitymov> {
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    iconTheme:  const IconThemeData(color: Colors.black),
     ...
     Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => (Citymovem()),
                ));
